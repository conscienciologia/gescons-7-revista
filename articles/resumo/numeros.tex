...
\section*{Lançamentos de obras em Português XY}
...
\toprule
\begin{minipage}[t]{\linewidth}\centering\textbf{Título}\end{minipage} &
\begin{minipage}[t]{\linewidth}\centering\textbf{Autor}\end{minipage} &
\begin{minipage}[t]{\linewidth}\centering\textbf{Lançamento}\end{minipage} \\
\midrule
\endfirsthead
...
% ---- Your data rows go HERE (after \endlastfoot)

\begin{minipage}[t]{\linewidth}\raggedright
Autolegado Evolutivo
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Haydée Melo e~Luciano~Melo~(Orgs.)
...
\begin{minipage}[t]{\linewidth}\raggedright
\emph{Mutatis Mutandis:} Teoria e~Prática da Reciclagem Existencial
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Luimara Schmit
\end{minipage} & \begin{minipage}[t]{\linewidth}\centering
10.08.2024
...
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Ana Luiza Rezende e~Mabel Teles (Orgs.)
\end{minipage} & \begin{minipage}[t]{\linewidth}\centering
24.08.2024
...
\hline
\begin{minipage}[t]{\linewidth}\raggedright
Grafoproéxis: A Escrita Conscienciológica enquanto Megafoco Existencial
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Cesar Machado
\end{minipage} & \begin{minipage}[t]{\linewidth}\centering
06.12.2025
...
\multicolumn{2}{c}{\textbf{Reimpressões de Obras no Biênio (continuação)}} \\
\hline
\begin{minipage}[t]{\linewidth}\centering\textbf{Título}\end{minipage} &
\begin{minipage}[t]{\linewidth}\centering\textbf{Autor}\end{minipage} \\
\midrule
...
\hline
\begin{minipage}[t]{\linewidth}\raggedright
\emph{Thesaurus} Terminológico da Conscienciologia em Português
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
...
\hline
\begin{minipage}[t]{\linewidth}\raggedright
Antologia de Experimentos da técnica de Mais 1 Ano de Vida Intrafísica
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Ana Claudia Prado \emph{et al.}
\end{minipage} \\ \addlinespace[4pt]
\hline
\begin{minipage}[t]{\linewidth}\raggedright
Otimizações pré-Tenepes
...
\hline
\begin{minipage}[t]{\linewidth}\raggedright
Livro dos Credores Grupocármicos
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Ernani Brito \emph{et al.}
\end{minipage} \\
\hline
\begin{minipage}[t]{\linewidth}\raggedright
Dicionário Neológico de Parafenomenologia
\end{minipage} & \begin{minipage}[t]{\linewidth}\raggedright
Ulisses Schlosser
\end{minipage} \\
\hline
