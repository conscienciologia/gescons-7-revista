...
A Editares é~resultado do \textbf{esforço coletivo de consciências engajadas na tarefa do esclarecimento (tares).} Cada livro, cada publicação e~cada projeto só são possíveis graças à~dedicação dos voluntários que integram nossas equipes. A~seguir, apresentamos a~listagem completa dos atuais voluntários, organizados por áreas de atuação, como forma de reconhecer e~valorizar a~tarefa diária que sustenta o~trabalho editorial da instituição.
