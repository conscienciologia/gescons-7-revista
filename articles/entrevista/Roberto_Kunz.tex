...
\begin{center}
    \includegraphics[width=7cm]{articles/entrevista/mockups/Roberto_Kunz}
\end{center}
...
\begin{pullquote}
    ``Não é~necessário saber exatamente o~que vai escrever, é~preciso ter um tema de interesse e~pesquisar muito.''
\end{pullquote}
